...
const Navbar = () => {
  ...
  return (
    <nav className="fixed left-0 right-0 z-50 lg:top-4">
      {/* Desktop Menu with Glassmorphism Effect */}
      <div className="mx-auto hidden max-w-4xl items-center justify-between rounded-3xl border border-white/30 py-3 px-8 backdrop-blur-lg lg:flex bg-white/80 dark:bg-slate-900/90 shadow-lg">
        <Link
          to="/"
          className="uppercase text-lg font-bold text-slate-900 dark:text-white whitespace-nowrap mr-6 tracking-wider focus:outline-none"
      ...
      <div className="py-3 px-6 backdrop-blur-md lg:hidden bg-white/90 dark:bg-slate-900/90 shadow-md rounded-2xl">
        <div className="flex items-center justify-between w-full">
          <Link
            to="/"
            className="pl-2 uppercase text-lg font-bold text-slate-900 dark:text-white whitespace-nowrap tracking-wider focus:outline-none"
            onClick={() => setMobileMenuOpen(false)}
          >
            Danish Nawaz
          </Link>
      ...
      {/* Glassmorphism and neumorphism styles */}
      <style>{`
        .shadow-neumorphism {
